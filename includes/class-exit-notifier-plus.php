...
border: 3px solid #1e5799;
			...
			// Analytics
			'analytics' => array(
				'enabled' => get_option('exitbox_google_analytics_enabled', '') == 'on',
				'property_id' => get_option('exitbox_google_analytics_property_id', ''),
				'event' => array(
					'category' => get_option('exitbox_google_analytics_event_category', ''),
