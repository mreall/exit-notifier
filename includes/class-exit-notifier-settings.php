...
.my-special-class {
	color: #ff0000;
		...
		$settings['analytics'] = array(
			'title'					=> __('Analytics', 'exit-notifier'),
			'description'			=> __('Track outbound link clicks in Google Analytics using Universal Analytics (does not support Google Analytics 4).', 'exit-notifier'),
			'fields'				=> array(
				array(
					'id' 			=> 'google_analytics_enabled',
					'label'			=> __('Enable event tracking?', 'exit-notifier'),
					'description'	=> __('With this box checked all outbound link clicks will trigger an event in Google Analytics', 'exit-notifier'),
					'type'			=> 'checkbox',
					'default'		=> 'off'
				),
				array(
				...
				array(
					'id' 			=> 'google_analytics_event_category',
					'label'			=> __('Event Category', 'exit-notifier'),
					'description'	=> __('<br>The event category under which all outbound links will be tracked', 'exit-notifier'),
					'type'			=> 'text',
					'default'		=> 'outbound-link'
				),
				array(
					'id' 			=> 'google_analytics_event_action_leave',
				...
				array(
					'id' 			=> 'google_analytics_event_action_stay',
